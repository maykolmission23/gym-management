         ...
         <tr>
           <td height="35"><table width="100%" border="0" align="center">
			 ...
			 <tr>
               ...
               <td height="35"><input type="email" name="m_email" id="boxx" required/ size="30"></td>
             </tr>

			 <tr>
               <td height="35">PASSWORD:</td>
               <td height="35"><input name="password" id="boxx"  required/></td>
             </tr>

			 <tr>
               <td height="35">AGE:</td>
               <td height="35"><input name="age" id="boxx" required ></td>
             </tr>
            ...
            <tr>
			 ...
			 <tr>
               ...
               <td height="35"><input type="number" name="mobile" id="boxx" maxlength="11" required/ size="30"></td>
             </tr>
