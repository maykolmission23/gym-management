...
<head>
	...
	<style>
		...
		.page-container .sidebar-menu #main-menu li#registerhassubopen > a {
    ...
    <body class="page-body  page-fade" onload="collapseSidebar()">
       ...
       <form id="form1" name="form1" method="post" class="a1-container" action="new_submit1.php">
         <table width="100%" border="0" align="center">
         <tr>
           <td height="35"><table width="100%" border="0" align="center">
           	 <tr>
           	   <td height="35">TRAINER ID:</td>
           	   <td height="35"><input type="text" id="boxx" name="train_id" value="<?php echo time(); ?>" readonly required/></td>
         	   </tr>
			   
			         <tr>
               <td height="35">NAME:</td>
               <td height="35"><input name="train_name" id="boxx"  required/></td>
             </tr>

			        <tr>
               <td height="35">EMAIL ID:</td>
               <td height="35"><input type="email" name="train_email" id="boxx" required/ size="30"></td>
             </tr>

			        <tr>
               <td height="35">PASSWORD:</td>
               <td height="35"><input  name="train_password" id="boxx"  required/></td>
             </tr>

			        <tr>
               <td height="35">AGE:</td>
               <td height="35"><input name="train_age" id="boxx"  required/></td>
             </tr>

			        <tr>
               <td height="35">SPECIALIZATION:</td>
               <td height="35"><input name="train_special" id="boxx"  required/></td>
             </tr>

             <tr>
               <td height="35">CITY:</td>
               <td height="35"><input type="text" name="t_city" id="boxx" required/ ></td>
             </tr>

             <tr>
               <td height="35">PROVINCE:</td>
               <td height="35"><input  name="t_province" id="boxx"   required/></td>
             </tr>

             <tr>
               <td height="35">BARANGAY:</td>
               <td height="35"><input type="text" name="t_barangay" id="boxx" required/ size="30"></td>
             </tr>

             <tr>
               <td height="35">ZIPCODE:</td>
               <td height="35"><input type="number" name="t_zipcode" id="boxx" maxlength="6" required / ></td>
             </tr>
