...
<ul id="main-menu" class="" >
	...
	<li class="" id="hassubopen"><a href="#" onclick="memberExpand()"><i class="entypo-users"></i><span>Trainer	</span></a>
		<ul id="memExpand">
			<li class="active">
				<a href="view_mem.php"><span>Edit Trainer</span></a></li>

			<li><a href="table_view.php"><span>View Trainer</span></a></li>

			<li><a href="table_view.php"><span>Add Trainer</span></a></li>
		</ul>
	</li>
