...
<head> 
    ...
    <body class="page-body  page-fade" onload="collapseSidebar()">
		...
		<div class="sidebar-menu">
			...
			<h1 style="color:white;">GYM<span style="color:orange;"> SQUAD</span></h1>
			...
			<div class="col-sm-3"><a href="trainers_view.php">			
				<div class="tile-stats tile-darkgray">
			...
			<div class="col-sm-3"><a href="pending.php">			
			...
			<div class="col-sm-3"><a href="session.php">			
				<div class="tile-stats tile-gray">
