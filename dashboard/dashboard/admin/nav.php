...
<ul id="main-menu" class="" >
	...
	<li id="session"><a href="session.php"><i class="entypo-inbox"></i><span>Session</span></a></li>

	<li id="pending"><a href="pending.php"><i class="entypo-archive"></i><span>Pending</span></a></li>

	<li class="" id="registerhassubopen"><a href="#" onclick="memberExpand(6)"><i class="entypo-user-add"></i><span>New Registration</span></a>
		<ul id="registerExpand">
			<li class="active">
				<a href="new_member.php"><span>New Member</span></a></li>

			<li><a href="new_trainer.php"><span>New Trainer</span></a></li>
		</ul>
	</li>
	...
	<li class="" id="trainhassubopen"><a href="#" onclick="memberExpand(5)"><i class="entypo-users"></i><span>Trainers</span></a>
		<ul id="trainExpand">
			<li class="active">
				<a href="trainers_edit.php"><span>Edit Trainers</span></a></li>

			<li><a href="trainers_view.php"><span>View Trainers</span></a></li>
		</ul>
	</li>
